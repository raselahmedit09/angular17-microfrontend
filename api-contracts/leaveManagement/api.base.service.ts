...
export class BaseService {
    protected basePath = 'https://localhost:7091';
    public defaultHeaders = new HttpHeaders();
    public configuration: LeaveManagementApiConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: LeaveManagementApiConfiguration) {
        this.configuration = configuration || new LeaveManagementApiConfiguration();
